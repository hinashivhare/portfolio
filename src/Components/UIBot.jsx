...
export default class UIBot extends React.Component {
    ...
    componentDidMount() {
        ...
        this.botui.message.bot({ // show first message
            ...
            return _that.botui.message.bot({ // second one
            ...
            return _that.botui.action.button({
                human: !0,
                action: [{
                    text: "Yes 👍",
                    value: 1
            ...
            return 1 === e.value ? _that.botui.message.add({
                loading: !0,
                delay: 1e3,
                content: "Cool !! 😎"
            }).then(function() {
                return _that.botui.message.add({
                    loading: !0,
                    delay: 2e3,
